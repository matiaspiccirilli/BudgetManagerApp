...
export const Header = () => {
  const { budget } = useControl()
  return (
    <header className='sticky top-0 z-50 w-full bg-zinc-900 backdrop-blur'>
      <div className='container flex items-center justify-between mx-auto border h-14 text-foreground'>
        ...
        <div className='inline-block font-bold md:hidden text-foreground'>
          SPENkool.
        </div>

        <div className='flex items-center justify-end space-x-2'>
          <nav className='flex items-center text-foreground gap-x-2'>
            <a
              target='_blank'
              rel='noreferrer'
